...
realizado sobre una única rama principal (\texttt{main}), sin emplear ramas de características
...
ciclo de control de versiones: cada \textit{push} a \texttt{main} desencadena
