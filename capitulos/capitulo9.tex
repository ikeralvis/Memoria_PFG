...
Las decisiones de diseño adoptadas en TankGo parten de una premisa común:
cuando existe incertidumbre sobre la necesidad real de un dato o sobre el
impacto de una funcionalidad, la posición por defecto es la que mejor protege
al usuario. En la práctica, esto se ha traducido en no acumular histórico de
coordenadas, en señalizar la naturaleza probabilística de las
predicciones y en no introducir ningún mecanismo que favorezca unas
estaciones sobre otras. El resultado es un sistema que puede ser útil sin
necesitar saber demasiado sobre quien lo usa.